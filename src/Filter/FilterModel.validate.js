...
import { VariableField } from 'evas-vue/src/Field/VariableField.js'

/** @var Function обработчик ошибок валидации */
FilterModel.validateErrorHandler = null
 ...
 * @return self
 */
FilterModel.setValidateErrorHandler = function (cb) {
 ...
 */
FilterModel.handleValidateError = function (field, error) {
...
FilterModel.prototype.$errors = []

/**
 * Очистка ошибок крайней валидации.
 */
FilterModel.prototype.$clearErrors = function () {
    this.$errors = []
}
 ...
 * @returns { Object }
 */
FilterModel.requiredFields = function () {
 ...
 * @returns { Array }
 */
FilterModel.requiredFieldNames = function () {
 ...
 */
FilterModel.prototype.$fieldNamesForValidate = function () {
 ...
 */
FilterModel.validate = function (entity, fieldNames = null) {
